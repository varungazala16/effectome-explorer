...
A proximity biology research tool for mapping the **effectome** of any human protein target — built with [General Proximity](https://www.generalproximity.bio)'s OmniTAC™ platform in mind.
...
- **Identifies proximity-relevant effectors** — E3 ubiquitin ligases, deubiquitylases (DUBs), kinases, and chaperones highlighted automatically
